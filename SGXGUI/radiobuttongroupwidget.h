...
#ifndef SYNGLYPHX_RADIOBUTTONGROUPBOX_H
#define SYNGLYPHX_RADIOBUTTONGROUPBOX_H
...
namespace SynGlyphX {
	...
	class SGXGUI_EXPORT RadioButtonGroupWidget : public QWidget
	{
		Q_OBJECT
...
#endif // SYNGLYPHX_RADIOBUTTONGROUPBOX_H
