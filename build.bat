...
SET CLASSPATH=%jp%;%drivers%\opencsv-3.7.jar;%drivers%\commons-lang3-3.1.jar;%drivers%\ojdbc7.jar;%drivers%\mysql-connector-java-5.1.38-bin.jar;%drivers%\sqlite-jdbc-3.8.11.2.jar;%drivers%\vertica-jdbc-7.2.1-0.jar;
...
SET currdir=%cd%
cd %outpath%
%jcmd%\jar cf dataengine.jar DataEngine.class GlyphEngine.class synglyphx\data\*.class synglyphx\glyph\*.class synglyphx\io\*.class synglyphx\util\*.class synglyphx\jdbc\*.class synglyphx\jdbc\driver\*.class synglyphx\link\*.class
