...
#ifndef INTERACTIVELEGENDWINDOW_H
#define INTERACTIVELEGENDWINDOW_H
...
class InteractiveLegendWindow : public QWidget
{
	Q_OBJECT

public:
	InteractiveLegendWindow(QWidget *parent, SynGlyphX::DataTransformMapping::ConstSharedPtr mapping);
...
#endif // INTERACTIVELEGENDWINDOW_H