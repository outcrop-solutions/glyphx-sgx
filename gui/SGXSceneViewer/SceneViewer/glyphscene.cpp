...
namespace SynGlyphX
{
	...
	Glyph3DNode* GlyphScene::allocGlyph( unsigned int _id, bool _isRoot, Glyph3DNodeType _type, int _filtering_index, uint32_t _label)
	{
		...
		++glyph_storage_next;
		return new ( mem ) Glyph3DNode( _id, _isRoot, _type, _filtering_index, _label );
	}
