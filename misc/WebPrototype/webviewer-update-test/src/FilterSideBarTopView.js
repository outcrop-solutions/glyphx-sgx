...
class FilterSideBarTopView extends React.Component {
    ...
    shouldComponentUpdate(nextProps, nextState) {
        return (this.state != nextState || this.props.initParams != nextProps.initParams || this.props.settings != nextProps.settings || this.props.filterIDs != nextProps.filterIDs || this.props.tableData != nextProps.tableData || this.props.statData != nextProps.statData || this.props.RecentVizDropdown != nextProps.RecentVizDropdown || this.props.statisticDisplay != nextProps.statisticDisplay);
                    ...
                    setCurrentVizParams(
                        {
                            ...
                            initialX: context.props.RecentVizDropdown.initialX,
                            initialY: context.props.RecentVizDropdown.initialY,
                            initialZ: context.props.RecentVizDropdown.initialZ,
                        }
                    )
                );
                resolve('done');
