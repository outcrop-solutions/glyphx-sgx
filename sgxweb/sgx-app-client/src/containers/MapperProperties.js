      ...
      <Grid container spacing={0}>
            ...
            {labels.map((row) => {
                return (
                    <div key={"input"+row.index}>
                        <Grid item xs={3}>
                            <img alt={"mapimg"+row.index} src={row.image} style={{float: 'left', width: 40, height: 40, marginLeft: 30, marginRight: 10}}/>
                        </Grid>
                        <Grid item xs={9}>
                            <Autocomplete
        ...
        <Grid item xs={9} style={{textAlign:'center'}}>
            <div style={{textAlign: 'center'}}>
                <img src={EmptyGlyph} alt="EmptyGlyph" style={{maxWidth: 225, marginTop: '13%'}}/>
